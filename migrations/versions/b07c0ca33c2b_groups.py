...
def upgrade():
    ...
    op.alter_column('auth_method', 'user_id',
               existing_type=sa.INTEGER(),
               nullable=False)
    op.alter_column('auth_method', 'auth_method',
               existing_type=sa.VARCHAR(),
               nullable=False)
    op.alter_column('auth_method', 'param',
               existing_type=sa.VARCHAR(),
               nullable=False)
    op.alter_column('auth_method', 'value',
               existing_type=sa.VARCHAR(),
               nullable=False)
    ...
    op.alter_column('user_session', 'user_id',
               existing_type=sa.INTEGER(),
               nullable=False)
    op.alter_column('user_session', 'expires',
