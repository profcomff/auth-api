...
1. Получаем Email для запроса на сервер Google: `GET /google/auth_url`
...
4. Если сервер авторизации ответил ошибкой 403, предлагаем пользователю завести новый аккаунт нашего приложения, связанный с гуглом
5. Если пользователь соглашается, делаем запрос с теми же данными, но на адрес `POST /google/register`
